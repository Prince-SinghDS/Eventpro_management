  ...
  return (
    <>
      ...
      <div className="lg:mx-20">
        <div className="grid flex-row gap-12 m-2 page-detail lg:grid-cols-3 lg:m-5 ">
          ...
          >
            ...
            >
              <p className=" font-bold text-[#FF6B66]">
                Number of Registrations :
                <strong className="ms-2">
                  {eventinfo?.total_registrations}
                </strong>
              </p>
            </div>
            <div className="flex flex-col details" style={{ border: "none" }}>
              <h2 className="m-3 mb-3 text-4xl font-bold text-[#FF6B66]">
                {eventinfo?.name}
              </h2>
              <div className="flex flex-row mt-5 gap-2">
                <div
                  className="mx-3 rounded"
                  style={{ width: "5px", backgroundColor: "#FF6B66" }}
                ></div>
                <div className="flex flex-col">
                  <p className="text-xl ">Venue</p>
                  <h4 className="text-2xl font-bold text-[#FF6B66]">
                    {eventinfo?.venue?.name}, {eventinfo?.venue?.address}
                  </h4>
                  <p className="text-lg text-grey">Date</p>
                  <h4 className="text-2xl font-bold text-[#FF6B66]">
                    {eventinfo?.start_date} to {eventinfo?.end_date}
                  </h4>
                  ...
                  <h4 className="text-2xl font-bold text-[#FF6B66]">
                    {eventinfo?.prize === "" ? "₹ 0" : `₹ ${eventinfo?.prize}`}
                  </h4>
                  <p className="text-xl text-grey">Registration Fee</p>
                  <h4 className="text-2xl font-bold text-[#FF6B66]">
                    {eventinfo?.reg_fee === "" || eventinfo?.reg_fee === "0"
                      ? "Free"
                      : `₹ ${eventinfo?.reg_fee}`}
                  </h4>
                </div>
        ...
        <div className="m-5 md:ms-4 md:w-7/12">
          ...
          <p
            className="my-4 col-12 col-lg-8"
            style={{ height: "2px", backgroundColor: "#dddddd" }}
          ></p>
        </div>
      </div>
      ...
      <div
        ...
        style={{ height: "70px ", backgroundColor: "#FAF9F6", width: "100%" }}
      >
        <button
          className="w=4/5"
          onClick={handleSubmit}
